...
The application is an error logging and monitoring tool similar to Sentry or Rollbar. A [deployed version](https://prolog-app-daniel-moderiano.vercel.app) of the main branch is constantly receiving updates. Note: you have to click the "Dashboard" link in the upper right corner to see the app as shown in the screenshot below.
